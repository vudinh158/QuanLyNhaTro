...
export default function TenantBillPaymentPage({ params }: { params: { id: string } }) {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        router.push(`/tenant/bills/${invoiceId}`); // Redirect back to invoice details
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      router.push(`/tenant/bills/${invoice.MaHoaDon}`);
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  {/* Remove paid/remaining as they are no longer direct columns */}
            ...
            <form onSubmit={handleSubmit}>
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Xác nhận khoản thanh toán.</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
