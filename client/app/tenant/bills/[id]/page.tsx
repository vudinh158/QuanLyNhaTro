...
import { AlertCircle, Printer, Wallet } from "lucide-react"
      ...
      <div className="flex flex-col gap-4">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {bill.status !== "paid" && (
              <Button asChild>
                <Link href={`/tenant/bills/${params.id}/payment`}>
              ...
              {bill.payments.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <Button className="mt-4" asChild>
                    <Link href={`/tenant/bills/${params.id}/payment`}>Thanh toán ngay</Link>
                  </Button>
                </div>
              )}
            </CardContent>
